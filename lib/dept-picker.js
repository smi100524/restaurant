...
(function () {
  ...
  style.textContent = [
    ...
    ".dept-panel{position:absolute;top:calc(100% + 4px);left:0;right:0;z-index:320;display:none;background:#fffdf7;border:1px solid #d8d2c4;border-radius:10px;box-shadow:0 12px 32px rgba(47,58,52,.16);max-height:240px;overflow-y:auto;padding:6px}",
